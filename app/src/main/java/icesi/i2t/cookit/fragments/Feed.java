...
import icesi.i2t.cookit.activities.RecyclerAdapterFeed;
...
//        list = container.findViewById(R.id.list_feed);
//        adapterFeed = new RecyclerAdapterFeed(container.getContext().getApplicationContext(), recipies);
